...
import useFastRegisterPaymentForm from './utils/useClientPayments'
import useClientPayments from './utils/useClientPayments'

interface FormModal {
  closeModal: () => void
}

function ClientPayments({ closeModal }: FormModal) {
  const {
