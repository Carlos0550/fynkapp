...
function ClientsWithLowestRisk() {
    const {
        resumeHook: {
            resumes: {
                best_customers
        ...
        >
            ...
            >
                ...
                <Text
                    ...
                    c={"#2c2c2c"}
                >
                    Estos clientes tienen el menor riesgo de morosidad.
                </Text>
                {best_customers && best_customers.length > 0 ? (
                    best_customers.map((customer) => (
                    ...
                    >
                        <Text
                            ...
                            c={"#2c2c2c"}
                        >
                            No hay suficientes clientes para mostrar
...
export default ClientsWithLowestRisk
